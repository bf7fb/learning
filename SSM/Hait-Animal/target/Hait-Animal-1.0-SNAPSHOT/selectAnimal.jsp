...
<script>
    ...
    document.getElementById("myimg").onclick = function (){
        ...
        if(count == 2){
            ...
            axios({
                method:"post",
                url:"http://43.138.71.63:8232/Hait-Animal/addLikesServlet",
                data: ${animal.id}
            }).then(function (resp){
...
<br>
<a href="http://43.138.71.63:8232/Hait-Animal/customerAnimal.html" target="_blank"><font color="red" size="5">返回</font></a>
